...
Heritage and the \textsc{swhid} --- an identifier computed from the code itself, defined in
Chapter~\ref{ch:identifiers} and now the international standard ISO/IEC~18670:2025. It addresses
