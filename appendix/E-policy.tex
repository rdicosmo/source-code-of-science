...
these notes should not have to rediscover, each time, which mandate said exactly what.
...
these notes and in the inventories behind them. Read each row as a pointer, not a paraphrase: the
...
Software policy did not appear from nowhere; it is the latest chapter of a twenty-year arc. Open
access to the \emph{literature} was declared in Budapest in 2002~\autocite{boai2002} and Berlin in
2003~\autocite{berlin2003}; open access to research \emph{data} was urged by the OECD in
2006~\autocite{OECD2021ResearchData} and codified, a decade later, in the FAIR
principles~\autocite{fairdefinition2016}; and the push to make open access immediate and mandatory
arrived with Plan~S in 2018~\autocite{plans2018}. Source \emph{code} is simply the next output to
travel the same road --- from voluntary good practice, to funder expectation, to law --- and the
matrix below is where it has reached so far.
...
\addlinespace
\textbf{FAIRCORE\-4EOSC}~\autocite{FAIRCORE4EOSC2022}%
...
\addlinespace
\textbf{ANR open-science funding guidelines}~\autocite{anr-openscience}%
  \newline\scriptsize\url{https://anr.fr/en/anrs-role-in-research/commitments/open-science/}
  & Agence nationale de la recherche & France & 2023
  & Funded-project software released under a free license, its source archived in Software
    Heritage and described in HAL with the ANR grant reference. \\
\addlinespace[4pt]
...
\textbf{Model curriculum vitae}~\autocite{DFG_CV_2022}%
  ...
  & Recognizes research software as a citable scholarly output in evaluation and CVs. \\
