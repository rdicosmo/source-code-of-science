...
change its hash --- a self-reference no hash function can satisfy (a fixed point it does not
have). This is not a limitation of Software Heritage; it is what makes the identifier
...
\begin{enumerate}[nosep,leftmargin=*]
  ...
  \item Compute the directory \textsc{swhid}: \texttt{swh identify -{}-type directory /tmp/note}.
