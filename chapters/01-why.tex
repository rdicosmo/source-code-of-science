...
\begin{figure}[htbp]
  ...
  granularity~\autocite{SWHecosystems2023}. A single research tool already rests on a deep web
  of other software --- none of which the data-deposit model knows how to keep.}
