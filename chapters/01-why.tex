...
now depends on software the authors wrote themselves~\autocite{osec_2022}. When the code
\emph{is} the experiment, pretending it is a detail does not make it one.
% TODO figure: French Open Science Monitor --- share of papers producing/using software,
% across disciplines. Asset: common/images/french_os_monitor-use-2025.png (or -share-2024.png).
% Likely CC-BY (ouvrirlascience / MESR); confirm and attribute. Cite osec_2022.
...
it depends on. These are not the properties of a dataset --- and, as we will see in the next
