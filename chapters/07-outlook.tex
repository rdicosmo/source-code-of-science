...
2022~\autocite{SwhCACM2018}. Papers now routinely carry not one identifier but many, pinpointing
their code passages with qualified \textsc{swhid}s throughout the
text~\autocite{spinellis2026hotspots}.
