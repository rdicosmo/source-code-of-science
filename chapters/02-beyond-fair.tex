...
% Figure: the matplotlib dependency graph (figures/python3-matplotlib.pdf) already appears in
% Ch.1 as Figure~\ref{fig:matplotlib-deps} --- reference it back here when drafting the
% "living nature / complexity" argument rather than repeating it.
